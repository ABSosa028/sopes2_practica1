...
asmlinkage long sys_fetch_system_time(void);

asmlinkage long sys_fetch_time_seconds(void);

asmlinkage long sys_get_ultimos_messages(char __user  *buffer, size_t size);
